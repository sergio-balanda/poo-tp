<?php
    require 'control.php';
     ...
     //capturas los input hidden, de modificar.php,request captura tanto get como post
    ...
    */
    ...
    if($funcion=="modificar"){
        $sql="update usuario set nombre='$nomb', password='$clave_md5', num_doc='$doc', tipo_doc='$tipo', rol='$rol' where idUsuario=$cod";
    }
